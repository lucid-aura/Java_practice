...
public class BootTest {
	...
	public static void main(String[] args) {
		...
		Book book5 = new Book("35535", "OOAD 분석,설계", "소나무", "Jaen.kr", 30000);

		Magazine magazine1 = new Magazine("35535", "Java World", "편집부", "Jaen.kr", 7000, 2013, 2);
		Magazine magazine2 = new Magazine("33434", "Mobile World", "편집부", "Jaen.kr", 8000, 2013, 8);
		Magazine magazine3 = new Magazine("75342", "Next Web", "편집부", "Jaen.kr", 10000, "AJAX 소개", 2012, 10);
		Magazine magazine4 = new Magazine("76543", "Architecture", "편집부", "Jaen.kr", 5000, "java 시스템", 2010, 3);
