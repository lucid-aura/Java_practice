...
//		
//		String student[][] = inputStudentInfo(sc, student);
//				
...
//		System.out.println("클래스의 1등은 " + student[index][0] + "님입니다");
	...
	public static String[][] inputStudentInfo(Scanner sc){
		String[][] student = null;
		System.out.print("학생 수 = ");
		int count = sc.nextInt();
		student = new String[count][5];
...
//		return c;
//	}
//	public static int add(Scanner sc, int a, int b) {
//		int c = a + b;
//		return c;
//	}
	static String[][] input(){
	...
	public static int[] topclass(String[][] student) {
		int ret[] = new int[2];
		int sum[] = sumFunc(student);
		int top = sum[0];	
		int index = 0;
