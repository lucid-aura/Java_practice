...
public class One {
	...
	public static void main(String[] args) {
		...
		switch(work) {
			...
			case 4:
				...
				System.out.println("10진수 " + numStr + " 의 16진수는" + num2to10 + "입니다.");
				break;
			case 5:
				int num8to10 = octToDec(numStr);
				System.out.println("10진수 " + numStr + " 의 16진수는" + num8to10 + "입니다.");
				break;
			case 6:
				int num16to10 = hexToDec(numStr);
				System.out.println("10진수 " + numStr + " 의 16진수는" + num16to10 + "입니다.");
				break;
		}
	...
	static int binToDec(String numStr) {
		int num10to2 = Integer.parseInt(numStr, 2);
		return num10to2;
	}
